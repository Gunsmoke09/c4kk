...
namespace LineUp
{
    public static class Program
    {
        ...
        {
            // Set up the effect display for "boring" and "magnetic" discs
            ...
            while (true)
            {
                ...
                {
                    // Test Mode
                    Console.Write("Please enter the moves, and each move should seperated by comma (e.g., o4, b3, m2): ");
        ...
        {
            // Ask user the number of rows and columns they want for the game grid
        ...
        private static int ReadInt(string prompt, int min, int max)
        {
            while (true)
            {
                // If user inputs an invalid number, prompt error and ask again
        ...
        private static void GameLoop(GameState gs)
        {
            while (!gs.GameOver)
            {
                ...
                Console.Write("[Please enter your move (e.g., o4, b2, m3), or 'save', 'help', 'quit']: ");
                ...
                if (parts[0].Equals("save", StringComparison.OrdinalIgnoreCase) && parts.Length >= 2 && parts[1].Equals("game", StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    string filePath = System.IO.Path.Combine(Directory.GetCurrentDirectory(), fileName); // Save in the current directory
